...
$TCA['tx_squad_domain_model_role'] = array(
	...
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, name, members',
	),
	'types' => array(
	...
	'columns' => array(
		...
		'members' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:squad/Resources/Private/Language/locallang_db.xlf:tx_squad_domain_model_role.members',
			'config' => array(
				'type' => 'select',
				'foreign_table' => 'tx_squad_domain_model_member',
				'MM' => 'tx_squad_role_member_mm',
				'size' => 10,
				'autoSizeMax' => 30,
				'maxitems' => 9999,
				'multiple' => 0,
				'wizards' => array(
					...
					'add' => Array(
						...
						'icon' => 'add.gif',
						'params' => array(
							'table' => 'tx_squad_domain_model_member',
							'pid' => '###CURRENT_PID###',
							'setValue' => 'prepend'
							),
